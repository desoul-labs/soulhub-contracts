    ...
    IERC3525SlotApprovableUpgradeable
{
    ...
    function approve(
        ...
        uint256 slot = ERC3525UpgradeableDS.slotOf(tokenId_);
        require(to_ != owner, "ERC3525: approval to current owner");

        require(
            _msgSender() == owner ||
                ERC721Upgradeable.isApprovedForAll(owner, _msgSender()) ||
                ERC3525SlotApprovableUpgradeableDS.isApprovedForSlot(
                    owner,
                    slot,
                    _msgSender()
                ),
    ...
    function approve(
        ...
        payable
        virtual
        override(IERC3525Upgradeable, ERC3525UpgradeableDS)
    {
        address owner = ERC721Upgradeable.ownerOf(tokenId_);
        require(to_ != owner, "ERC3525: approval to current owner");
