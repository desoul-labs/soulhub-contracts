...
```solidity
function initialize(address owner, uint256 threshold, string baseTokenURI, address erc5727Address, uint256 slot) external nonpayable
```
...
| erc5727Address | address | undefined   |
