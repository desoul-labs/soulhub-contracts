...
interface IERC5727Recovery is IERC5727 {
     ...
     * @param status Challenge status indicating whether the challenge operation was successful or not
     */
    event RecoveryChallenged(address indexed from, bool status);
